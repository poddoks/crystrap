...
namespace Bloxstrap.UI.ViewModels.Installer
{
    public class CompletionViewModel
    {
        ...
        public void LaunchSettings() => CloseWindowRequest?.Invoke(this, NextAction.LaunchSettings);

        private void LaunchRoblox() => CloseWindowRequest?.Invoke(this, NextAction.LaunchRoblox);

        public void LaunchRobloxThenSettings() => CloseWindowRequest?.Invoke(this, NextAction.LaunchRobloxThenSettings);
    }
}
