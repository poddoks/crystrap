...
namespace Bloxstrap.UI.ViewModels.Installer
{
    public class LaunchMenuViewModel
    {
        ...
        public ICommand LaunchPureRobloxCommand => new RelayCommand(LaunchPureRoblox);
        ...
        private void LaunchPureRoblox() => CloseWindowRequest?.Invoke(this, NextAction.LaunchPureRoblox);
