    ...
    static class BootstrapperIconEx
    {
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            if (icon == BootstrapperIcon.IconCustom)
            {
                ...
                return customIcon ?? Properties.Resources.IconCrystrap;
            }

            return icon switch
            {
                BootstrapperIcon.IconCrystrap => Properties.Resources.IconCrystrap,
                ...
                _ => Properties.Resources.IconCrystrap
            };
        }

        public static ImageSource GetImageSource(this BootstrapperIcon icon)
        {
            if (icon == BootstrapperIcon.IconCrystrap)
                return new BitmapImage(new Uri("pack://application:,,,/Resources/crystrap-icon.png", UriKind.Absolute));
